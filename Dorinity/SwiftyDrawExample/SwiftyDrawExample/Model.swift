...
class Model {
    ...
    func updateWithDelta(_ dtY: CGFloat, _ dtZ: CGFloat) {
 ...
 //       let path = Bundle.main.path(forResource: filename, ofType: nil)!
        let path: String = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first! + "/"+filename
        print(path)
